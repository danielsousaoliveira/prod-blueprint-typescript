...
import { interval } from '../../starter/shared/intervals/interval';
import { AvailabilityService } from '../modules/availability/application/availability.service';
import {
  AppointmentService,
  type BookingError,
  events,
} from '../modules/appointments/application/appointment.service';
...
import { CurrentActor } from '../../starter/modules/auth/actor.decorator';
import type { Actor } from '../../starter/modules/auth/domain/user';
import {
  AppointmentGql,
  AvailabilityGql,
...
} from '../../starter/modules/graphql/graphql.types';
 ...
 * later — see documented design choice for the Cloud Run consequences.
 */
...
export class DoctorResolver {
   ...
   * therefore what makes depth limiting meaningful (documented design choice). It now returns the
